      ...
      <div className="payslip-container bg-white p-4 sm:p-8 md:p-12 rounded-2xl border border-slate-200 shadow-sm max-w-4xl mx-auto space-y-6 sm:space-y-8 text-slate-800 w-full overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="border border-slate-200 rounded-xl overflow-hidden shadow-2xs">
            <div className="bg-slate-100 text-slate-800 border-b border-slate-200 px-4 py-2.5 font-bold text-xs uppercase tracking-wider flex items-center justify-between">
              <span>EARNINGS</span>
              <span>AMOUNT (₹)</span>
            </div>
