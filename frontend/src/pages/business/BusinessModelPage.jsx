...
const BusinessModelPage = () => {
  ...
  return (
    <div className="space-y-8 pb-12">
      {/* Header Banner */}
      <div className="bg-gradient-to-r from-slate-900 via-indigo-950 to-slate-900 rounded-2xl p-8 border border-slate-800 text-white shadow-xl relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            ...
            <h1 className="text-3xl font-extrabold tracking-tight">PeoplePay360 Business Model</h1>
          ...
          <div className="flex items-center space-x-3">
            <button
              ...
              className="inline-flex items-center px-4 py-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 text-sm font-medium border border-slate-700 shadow-sm transition-all"
            >
      ...
      {activeTab === 'pricing' && (
        <div className="space-y-8 animate-fadeIn">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white dark:bg-slate-900 p-4 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm">
            <div>
              <h2 className="text-base font-bold text-slate-900 dark:text-white">Predictable Hybrid PEPM Pricing</h2>
              <p className="text-xs text-slate-500 dark:text-slate-400">Scale seamlessly with transparent per-employee-per-month licensing.</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Tier 1: Starter */}
            <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col justify-between hover:border-slate-300 dark:hover:border-slate-700 transition-all">
              <div>
                ...
                <h3 className="text-xl font-bold text-slate-900 dark:text-white mt-3">Essential HR</h3>
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Best for small businesses with 5–30 employees.</p>
              ...
              <button className="w-full mt-6 py-2.5 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-200 text-xs font-bold transition-all">
                Get Started
              </button>
            </div>

            {/* Tier 2: Professional (Featured) */}
            <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 border-2 border-indigo-600 shadow-lg flex flex-col justify-between relative">
              ...
              <div>
                ...
                <h3 className="text-xl font-bold text-slate-900 dark:text-white mt-3">Professional</h3>
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Best for scaling companies with 30–250 employees.</p>
                <div className="mt-4 pb-4 border-b border-slate-100 dark:border-slate-800">
                  <div className="flex items-baseline">
                    <span className="text-3xl font-extrabold text-slate-900 dark:text-white">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col justify-between hover:border-slate-300 dark:hover:border-slate-700 transition-all">
              <div>
                ...
                <h3 className="text-xl font-bold text-slate-900 dark:text-white mt-3">Scale & Global</h3>
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Best for mid-to-large orgs with 250+ employees.</p>
                <div className="mt-4 pb-4 border-b border-slate-100 dark:border-slate-800">
                  <div className="flex items-baseline">
                    <span className="text-3xl font-extrabold text-slate-900 dark:text-white">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col justify-between hover:border-slate-300 dark:hover:border-slate-700 transition-all">
              <div>
                <span className="px-2.5 py-1 rounded-full bg-emerald-50 dark:bg-emerald-950/60 text-emerald-600 dark:text-emerald-400 text-[10px] font-bold uppercase tracking-wider">
                  Partner Edition
                </span>
                <h3 className="text-xl font-bold text-slate-900 dark:text-white mt-3">Payroll Bureau</h3>
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">For accounting firms managing multiple client companies.</p>
                <div className="mt-4 pb-4 border-b border-slate-100 dark:border-slate-800">
                  <div className="flex items-baseline">
                    <span className="text-3xl font-extrabold text-slate-900 dark:text-white">
          ...
          <div className="bg-slate-50 dark:bg-slate-900/50 p-6 rounded-2xl border border-slate-200 dark:border-slate-800">
            <h3 className="text-sm font-bold text-slate-900 dark:text-white mb-1">High-Margin Expansion Revenue Streams (Fintech & AI Rails)</h3>
            <p className="text-xs text-slate-500 dark:text-slate-400 mb-4">Complementary monetization modules increasing Net Revenue Retention (NRR &gt; 130%).</p>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div className="bg-white dark:bg-slate-800 p-4 rounded-xl border border-slate-200 dark:border-slate-700">
                ...
                <div className="text-lg font-extrabold text-emerald-600 dark:text-emerald-400 mt-1">1.50% <span className="text-xs font-normal text-slate-500">fee</span></div>
      ...
      {activeTab === 'roi' && (
        <div className="space-y-6 animate-fadeIn">
          <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800 shadow-sm">
            <h2 className="text-lg font-bold text-slate-900 dark:text-white">Interactive Customer ROI & Efficiency Calculator</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-6">
              {/* Sliders */}
              <div className="space-y-6 bg-slate-50 dark:bg-slate-800/40 p-5 rounded-xl border border-slate-200 dark:border-slate-700">
                <div>
                  <div className="flex justify-between items-center mb-2">
                    <label className="text-xs font-bold text-slate-700 dark:text-slate-300">Total Active Employees</label>
                    <span className="text-sm font-extrabold text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-950/60 px-2.5 py-0.5 rounded-md">
                      {employeeCount} Staff
                    </span>
                  </div>
                  <input
                ...
                <div>
                  <div className="flex justify-between items-center mb-2">
                    <label className="text-xs font-bold text-slate-700 dark:text-slate-300">Monthly HR / Payroll Hours Spent</label>
                    <span className="text-sm font-extrabold text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-950/60 px-2.5 py-0.5 rounded-md">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-indigo-50 dark:bg-indigo-950/30 p-4 rounded-xl border border-indigo-200 dark:border-indigo-800/50 flex flex-col justify-between">
                  <span className="text-[11px] font-bold text-indigo-700 dark:text-indigo-400 uppercase tracking-wider">Hours Saved Yearly</span>
                  <div className="text-3xl font-extrabold text-indigo-700 dark:text-indigo-300 mt-2">
                    {annualHoursSaved} hrs
                  </div>
                  <p className="text-[11px] text-indigo-600 dark:text-indigo-400 mt-1">Freed up for strategic talent development and culture.</p>
                </div>

                <div className="bg-purple-50 dark:bg-purple-950/30 p-4 rounded-xl border border-purple-200 dark:border-purple-800/50 flex flex-col justify-between">
                  <span className="text-[11px] font-bold text-purple-700 dark:text-purple-400 uppercase tracking-wider">Payback Period</span>
                  <div className="text-3xl font-extrabold text-purple-700 dark:text-purple-300 mt-2">
                    {paybackMonths} mo
                  </div>
                  <p className="text-[11px] text-purple-600 dark:text-purple-400 mt-1">Rapid return on software investment.</p>
                </div>

                <div className="bg-amber-50 dark:bg-amber-950/30 p-4 rounded-xl border border-amber-200 dark:border-amber-800/50 flex flex-col justify-between">
                  <span className="text-[11px] font-bold text-amber-700 dark:text-amber-400 uppercase tracking-wider">Estimated LTV : CAC</span>
                  <div className="text-3xl font-extrabold text-amber-700 dark:text-amber-300 mt-2">
                    5.8x
                  </div>
                  <p className="text-[11px] text-amber-600 dark:text-amber-400 mt-1">Industry-leading SaaS unit economic efficiency.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {activeTab === 'canvas' && (
        <div className="space-y-6 animate-fadeIn">
          <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800 shadow-sm">
            <h2 className="text-lg font-bold text-slate-900 dark:text-white">The 9-Pillar Business Model Canvas</h2>
            <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Structured architectural breakdown of PeoplePay360's operational and commercial engine.</p>

            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4 mt-6">
              {/* Key Partners */}
              <div className="bg-slate-50 dark:bg-slate-800/50 p-4 rounded-xl border border-slate-200 dark:border-slate-700">
                <span className="text-[10px] font-bold uppercase tracking-wider text-indigo-600 dark:text-indigo-400">1. Key Partners</span>
                <h4 className="text-xs font-bold text-slate-900 dark:text-white mt-1">Ecosystem Allies</h4>
                <ul className="mt-3 text-[11px] text-slate-600 dark:text-slate-300 space-y-1.5 list-disc list-inside">
              ...
              {/* Key Activities */}
              <div className="bg-slate-50 dark:bg-slate-800/50 p-4 rounded-xl border border-slate-200 dark:border-slate-700">
                <span className="text-[10px] font-bold uppercase tracking-wider text-indigo-600 dark:text-indigo-400">2. Key Activities</span>
                <h4 className="text-xs font-bold text-slate-900 dark:text-white mt-1">Core Operations</h4>
                <ul className="mt-3 text-[11px] text-slate-600 dark:text-slate-300 space-y-1.5 list-disc list-inside">
              ...
              {/* Value Propositions */}
              <div className="bg-indigo-50 dark:bg-indigo-950/30 p-4 rounded-xl border border-indigo-200 dark:border-indigo-800/60 lg:col-span-1">
                <span className="text-[10px] font-bold uppercase tracking-wider text-indigo-700 dark:text-indigo-300">3. Value Proposition</span>
                <h4 className="text-xs font-bold text-indigo-950 dark:text-white mt-1">Unique Differentiation</h4>
                <ul className="mt-3 text-[11px] text-indigo-900 dark:text-indigo-200 space-y-1.5 list-disc list-inside">
              ...
              <div className="bg-slate-50 dark:bg-slate-800/50 p-4 rounded-xl border border-slate-200 dark:border-slate-700">
                <span className="text-[10px] font-bold uppercase tracking-wider text-indigo-600 dark:text-indigo-400">4. Relationships</span>
                <h4 className="text-xs font-bold text-slate-900 dark:text-white mt-1">Customer Touchpoints</h4>
                <ul className="mt-3 text-[11px] text-slate-600 dark:text-slate-300 space-y-1.5 list-disc list-inside">
              ...
              {/* Customer Segments */}
              <div className="bg-slate-50 dark:bg-slate-800/50 p-4 rounded-xl border border-slate-200 dark:border-slate-700">
                <span className="text-[10px] font-bold uppercase tracking-wider text-indigo-600 dark:text-indigo-400">5. Segments</span>
                <h4 className="text-xs font-bold text-slate-900 dark:text-white mt-1">Target Market</h4>
                <ul className="mt-3 text-[11px] text-slate-600 dark:text-slate-300 space-y-1.5 list-disc list-inside">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
              <div className="bg-slate-50 dark:bg-slate-800/40 p-4 rounded-xl border border-slate-200 dark:border-slate-700">
                <span className="text-[10px] font-bold uppercase tracking-wider text-rose-600 dark:text-rose-400">6. Cost Structure</span>
              ...
              <div className="bg-slate-50 dark:bg-slate-800/40 p-4 rounded-xl border border-slate-200 dark:border-slate-700">
                <span className="text-[10px] font-bold uppercase tracking-wider text-emerald-600 dark:text-emerald-400">7. Revenue Streams</span>
                <div className="grid grid-cols-2 gap-2 mt-2 text-xs">
      ...
      {activeTab === 'competition' && (
        <div className="space-y-6 animate-fadeIn">
          <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800 shadow-sm overflow-x-auto">
            <h2 className="text-lg font-bold text-slate-900 dark:text-white">Competitive Benchmark Matrix</h2>
            <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Why PeoplePay360 outperforms legacy desktop software and bloated legacy ERPs.</p>

            <table className="w-full text-left text-xs mt-6 border-collapse">
              <thead>
                <tr className="border-b border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/50">
                  <th className="p-3 font-bold text-slate-700 dark:text-slate-300">Feature / Dimension</th>
                  ...
                  <th className="p-3 font-bold text-indigo-600 dark:text-indigo-400 bg-indigo-50/50 dark:bg-indigo-950/30">PeoplePay360</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                <tr>
                  <td className="p-3 font-semibold text-slate-800 dark:text-slate-200">Implementation Time</td>
                  ...
                  <td className="p-3 font-bold text-emerald-600 dark:text-emerald-400 bg-indigo-50/30 dark:bg-indigo-950/20">&lt; 30 Minutes (Self-serve)</td>
                </tr>
                <tr>
                  <td className="p-3 font-semibold text-slate-800 dark:text-slate-200">Contract Period Auto-Resolution</td>
                  ...
                  <td className="p-3 font-bold text-emerald-600 dark:text-emerald-400 bg-indigo-50/30 dark:bg-indigo-950/20">Native Automated Matching</td>
                </tr>
                <tr>
                  <td className="p-3 font-semibold text-slate-800 dark:text-slate-200">Leave Allocation Auto-Consumption</td>
                  ...
                  <td className="p-3 font-bold text-emerald-600 dark:text-emerald-400 bg-indigo-50/30 dark:bg-indigo-950/20">Real-time Balance Deduction</td>
                </tr>
                <tr>
                  <td className="p-3 font-semibold text-slate-800 dark:text-slate-200">Salary Rule Sequence Engine</td>
                  ...
                  <td className="p-3 font-bold text-emerald-600 dark:text-emerald-400 bg-indigo-50/30 dark:bg-indigo-950/20">Visual Ordered Execution Engine</td>
                </tr>
                <tr>
                  <td className="p-3 font-semibold text-slate-800 dark:text-slate-200">Pre-Payrun Validation Warnings</td>
                  ...
                  <td className="p-3 font-bold text-emerald-600 dark:text-emerald-400 bg-indigo-50/30 dark:bg-indigo-950/20">Live Proactive Anomaly Alerts</td>
                </tr>
              </tbody>
            </table>
          </div>
