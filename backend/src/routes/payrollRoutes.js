...
router.get('/eligibility', authenticate, authorize(['admin', 'hr', 'payroll']), payrollController.getPayrollEligibility);
...
router.post('/:id/send', authenticate, authorize(['admin', 'payroll']), payrollController.sendPayrollPayslips);
